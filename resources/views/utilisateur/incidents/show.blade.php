<x-app-layout>
    ...
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <ul class="list-disc pl-5 text-gray-700">
                    @foreach ($incident->commentaires as $commentaire)
                        <li class="mb-2">
                            ...
                            <span class="text-gray-500 text-sm">({{ $commentaire->created_at->format('d/m/Y H:i') }})</span>
                        </li>
                    @endforeach
                </ul>
            @else
        ...
        <div class="mt-6">
            <a href="{{ route('utilisateur.incidents.index') }}" class="text-blue-600 hover:underline">
                ← Retour à la liste
            </a>
        </div>
    </div>
