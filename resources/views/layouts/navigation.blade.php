            ...
            <div class="hidden sm:flex space-x-8">
                ...
                @auth
                    ...
                    @elseif(auth()->user()->estUtilisateur())
                        <x-nav-link :href="route('utilisateur.incidents.index')" :active="request()->routeIs('utilisateur.incidents.*')" class="text-gray-800 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400">
                            {{ __('Mes Incidents') }}
                        </x-nav-link>
                    @endif
                @endauth
