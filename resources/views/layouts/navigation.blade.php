        ...
        <div class="sm:hidden mt-2 px-4" x-show="open" x-cloak>
            <div class="flex flex-col space-y-2">
                @auth
                    ...
                    @elseif(auth()->user()->estUtilisateur())
                        <x-nav-link :href="route('utilisateur.home')" class="block">
                            {{ __('Accueil') }}
                        </x-nav-link>
                        <x-nav-link :href="route('utilisateur.incidents.categories')" class="block">
                            {{ __('Catalogue des incidents') }}
                        </x-nav-link>
                        <x-nav-link :href="route('utilisateur.incidents.index')" class="block">
                            {{ __('Mes incidents') }}
                        </x-nav-link>
                        <x-nav-link :href="route('dashboard')" class="block">
                            {{ __('Tableau de bord') }}
