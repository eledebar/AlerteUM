            ...
            <tbody>
                @foreach ($incidents as $incident)
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.incidents.edit', $incident) }}" class="text-blue-500 mr-2">Modifier</a>

                            <form action="{{ route('admin.incidents.destroy', $incident) }}" method="POST" class="inline-block" onsubmit="return confirm('Supprimer cet incident ?')">
                                @csrf
                                @method('DELETE')
